<template>
  ...
  .slider {
    ...
    right: 0;
    bottom: 0;
    background-color: #2a2a2a; /* malam (default dark) */
    transition: 0.4s;
    border-radius: 30px;
    overflow: hidden;
  }
  ...
  .slider:before {
    ...
    box-shadow: inset 8px -4px 0px 0px #fff; /* bulan */
  }
  
  .switch input:not(:checked) + .slider {
    background-color: #00a6ff; /* siang (light) */
  }
  
  .switch input:not(:checked) + .slider:before {
    box-shadow: inset 15px -4px 0px 15px #ffcf48; /* matahari */
  }
